    ...
    def postprocess(self,results):
        with ScopedTiming("postprocess",self.debug_mode > 0):
            if self.task_type=="classify":
                ...
                new_result=results[0][0].transpose()
                if self.mode=="image":
                    pose_res = aidemo.yolov8_pose_postprocess(new_result.copy(),[self.rgb888p_size[1],self.rgb888p_size[0]],[self.model_input_size[1],self.model_input_size[0]],[self.rgb888p_size[1],self.rgb888p_size[0]],len(self.labels),self.kp_num,self.kp_dim,self.conf_thresh,self.nms_thresh,self.max_boxes_num)
                elif self.mode=="video":
                    pose_res = aidemo.yolov8_pose_postprocess(new_result.copy(),[self.rgb888p_size[1],self.rgb888p_size[0]],[self.model_input_size[1],self.model_input_size[0]],[self.display_size[1],self.display_size[0]],len(self.labels),self.kp_num,self.kp_dim,self.conf_thresh,self.nms_thresh,self.max_boxes_num)
                return pose_res
    ...
    def postprocess(self,results):
        with ScopedTiming("postprocess",self.debug_mode > 0):
            if self.task_type=="classify":
                ...
                if self.mode=="image":
                    det_res = aidemo.yolo26_det_postprocess(results[0][0],[self.rgb888p_size[1],self.rgb888p_size[0]],[self.model_input_size[1],self.model_input_size[0]],[self.rgb888p_size[1],self.rgb888p_size[0]],len(self.labels),self.conf_thresh,self.max_boxes_num)
                elif self.mode=="video":
                    det_res = aidemo.yolo26_det_postprocess(results[0][0],[self.rgb888p_size[1],self.rgb888p_size[0]],[self.model_input_size[1],self.model_input_size[0]],[self.display_size[1],self.display_size[0]],len(self.labels),self.conf_thresh,self.max_boxes_num)
                return det_res
            elif self.task_type=="segment":
                if self.mode=="image":
                    seg_res = aidemo.yolo26_seg_postprocess(results[0][0],results[1][0],[self.rgb888p_size[1],self.rgb888p_size[0]],[self.model_input_size[1],self.model_input_size[0]],[self.rgb888p_size[1],self.rgb888p_size[0]],len(self.labels),self.conf_thresh,self.mask_thresh,self.masks)
                elif self.mode=="video":
                    seg_res = aidemo.yolo26_seg_postprocess(results[0][0],results[1][0],[self.rgb888p_size[1],self.rgb888p_size[0]],[self.model_input_size[1],self.model_input_size[0]],[self.display_size[1],self.display_size[0]],len(self.labels),self.conf_thresh,self.mask_thresh,self.masks)
                return seg_res
            elif self.task_type=="obb":
                if self.mode=="image":
                    obb_res = aidemo.yolo26_obb_postprocess(results[0][0],[self.rgb888p_size[1],self.rgb888p_size[0]],[self.model_input_size[1],self.model_input_size[0]],[self.rgb888p_size[1],self.rgb888p_size[0]],len(self.labels),self.conf_thresh,self.max_boxes_num)
                elif self.mode=="video":
                    obb_res = aidemo.yolo26_obb_postprocess(results[0][0],[self.rgb888p_size[1],self.rgb888p_size[0]],[self.model_input_size[1],self.model_input_size[0]],[self.display_size[1],self.display_size[0]],len(self.labels),self.conf_thresh,self.max_boxes_num)
                return obb_res
            elif self.task_type=="pose":
                if self.mode=="image":
                    pose_res = aidemo.yolo26_pose_postprocess(results[0][0],[self.rgb888p_size[1],self.rgb888p_size[0]],[self.model_input_size[1],self.model_input_size[0]],[self.rgb888p_size[1],self.rgb888p_size[0]],len(self.labels),self.kp_num,self.kp_dim,self.conf_thresh,self.max_boxes_num)
                elif self.mode=="video":
                    pose_res = aidemo.yolo26_pose_postprocess(results[0][0],[self.rgb888p_size[1],self.rgb888p_size[0]],[self.model_input_size[1],self.model_input_size[0]],[self.display_size[1],self.display_size[0]],len(self.labels),self.kp_num,self.kp_dim,self.conf_thresh,self.max_boxes_num)
                return pose_res
